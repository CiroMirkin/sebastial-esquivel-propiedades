      ...
      <div className="mx-auto max-w-7xl px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-secondary-300 text-sm leading-relaxed">
            Especialistas en venta de propiedades en Zona Oeste y CABA con un plan de comercialización premium.
          </p>
          <p className="text-secondary-500 text-xs">CMCPDJLM 1074 | CUCICBA 9497</p>
        </div>

        <div className="flex flex-col gap-3">
          <span className="text-xs tracking-widest uppercase text-secondary-400 mb-1">Navegación</span>
          {navLinks.map((link) =>
            link.external ? (
              <a
                key={link.href}
        ...
        <div className="flex flex-col gap-4">
          <span className="text-xs tracking-widest uppercase text-secondary-400 mb-1">Contacto</span>
          <a
          ...
          <p className="text-sm text-secondary-400">Arévalo 1880, Palermo, CABA</p>

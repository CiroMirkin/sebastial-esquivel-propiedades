  ...
  return (
    <>
      ...
      <section className="relative py-28 bg-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(81,154,207,0.06),_transparent_55%)]" />
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <p className="text-secondary/70 text-lg max-w-2xl leading-relaxed">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-px bg-primary/20">
            {team.map((member) => (
              <div
                key={member.name}
                className="bg-white p-8 flex flex-col items-center text-center gap-4 hover:bg-primary/5 transition-colors group"
              >
                  <div className="w-20 h-20 bg-primary/10 border border-secondary/30 group-hover:border-primary/40 transition-colors flex items-center justify-center font-serif text-xl text-primary">
                  {member.initials}
                </div>
                <div>
                  ...
                  <p className="text-secondary/60 text-xs leading-snug">
                    {member.role}
                  </p>
                </div>
              </div>

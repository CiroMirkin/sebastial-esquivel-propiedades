  ...
  return (
    <>
      ...
      <section className="relative py-28 bg-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(81,154,207,0.06),_transparent_55%)]" />
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-px bg-primary/20 mt-4">
              {[
          ...
          <div className="border border-primary/20 bg-primary/5 p-8 flex flex-col gap-4">
      ...
      <section className="py-24 bg-primary/5 border-t border-b border-primary/20">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="font-serif text-4xl text-secondary mb-12">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="flex flex-col gap-4">
            <h2 className="font-serif text-4xl text-secondary">Contacto</h2>
            <p className="text-secondary/70 text-sm">
            ...
            <div className="flex flex-col gap-3 pt-4">
              <a
                ...
                className="flex items-center gap-3 text-secondary hover:text-primary transition-colors text-sm"
              >
              ...
              >
                ...
                <p className="flex items-center gap-3 text-secondary/60 text-sm">
                  <span className="w-8 h-8 border border-secondary/30 flex items-center justify-center shrink-0">
                  <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-primary text-white hover:bg-primary/90 transition-colors px-8 py-4 text-xs tracking-widest uppercase font-semibold self-start mt-2"
            >
              Enviar
            </button>
          </form>

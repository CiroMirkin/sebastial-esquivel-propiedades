  ...
  return (
    <>
      ...
      <section className="relative py-28 bg-stone-950 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(180,130,50,0.1),_transparent_55%)]" />
        <div className="relative mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          ...
          <div className="border border-amber-400/30 bg-amber-400/5 p-8">
            <p className="font-serif text-2xl text-amber-400 mb-2">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-px bg-stone-800 mt-4">
              {[
                ...
                <div
                  key={item.step}
                  className="bg-stone-950 p-5 flex flex-col gap-2"
                >
          ...
          <div className="border border-stone-800 bg-stone-900/30 p-8 flex flex-col gap-4">
      ...
      <section className="py-24 bg-stone-900/30 border-t border-b border-stone-800">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="font-serif text-4xl text-stone-50 mb-12">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="flex flex-col gap-4">
            <h2 className="font-serif text-4xl text-stone-50">Contacto</h2>
            <p className="text-stone-400 text-sm">
            ...
            <div className="flex flex-col gap-3 pt-4">
              <a
                ...
                className="flex items-center gap-3 text-stone-300 hover:text-amber-400 transition-colors text-sm"
              >
                <span className="w-8 h-8 border border-stone-700 flex items-center justify-center shrink-0">
              ...
              <p className="flex items-center gap-3 text-stone-500 text-sm">
                <span className="w-8 h-8 border border-stone-700 flex items-center justify-center shrink-0">
                  <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-amber-400 text-stone-950 hover:bg-amber-300 transition-colors px-8 py-4 text-xs tracking-widest uppercase font-semibold self-start mt-2"
            >
              Enviar
            </button>
          </form>

  ...
  return (
    <>
      ...
      <section className="relative py-28 bg-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_rgba(81,154,207,0.06),_transparent_55%)]" />
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <p className="text-secondary/70 text-lg max-w-lg leading-relaxed">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-5">
              <a
                ...
                className="group flex items-center gap-5 border border-primary/20 hover:border-primary/40 bg-primary/5 hover:bg-primary/10 transition-all p-6"
              >
                <div className="w-12 h-12 border border-secondary/30 group-hover:border-primary/40 transition-colors flex items-center justify-center text-secondary/70 group-hover:text-primary shrink-0">
                ...
                <div>
                  ...
                  <p className="text-secondary group-hover:text-primary transition-colors font-medium">
                    +54 11 3777-5276
                  </p>
                </div>
              </a>
              ...
              <div                 className="flex items-center gap-5 border border-primary/20 bg-primary/5 p-6">
                  <div className="w-12 h-12 border border-secondary/30 flex items-center justify-center text-secondary/70 shrink-0">
                  <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  ...
                  <address className="not-italic text-secondary font-medium text-sm">
          ...
          <form className="flex flex-col gap-5">
            <h2 className="font-serif text-3xl text-secondary mb-2">
              Envianos un mensaje
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  type="text"
                  className="bg-white border border-secondary/30 focus:border-primary/60 outline-none text-secondary px-4 py-3 text-sm transition-colors placeholder:text-secondary/40"
            ...
            <button
              type="submit"
              className="bg-primary text-white hover:bg-primary/90 transition-colors px-8 py-4 text-xs tracking-widest uppercase font-semibold self-start"
            >
              Enviar mensaje
            </button>
          </form>

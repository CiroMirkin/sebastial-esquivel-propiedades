  ...
  return (
    <>
      ...
      <section className="relative py-28 bg-primary-50 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_rgba(81,154,207,0.15),_transparent_55%)]" />
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-5">
              <a
                ...
                className="group flex items-center gap-5 border border-primary-200 hover:border-primary-400 bg-primary-50 hover:bg-primary-100 transition-all p-6"
              >
                <div className="w-12 h-12 border border-secondary-200 group-hover:border-primary-400 transition-colors flex items-center justify-center text-secondary-500 group-hover:text-primary-600 shrink-0">
                ...
                <div>
                  <p className="text-xs tracking-widest uppercase text-secondary-500 mb-1">
                    WhatsApp
                  </p>
                  <p className="text-secondary-800 group-hover:text-primary-600 transition-colors font-medium">
                    +54 11 3777-5276
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-800 group-hover:text-primary-600 transition-colors font-medium break-all">
                    sebastianesquivel@deinmobiliarios.com
                  </p>
                </div>
              </a>

              <div className="flex items-center gap-5 border border-primary-200 bg-primary-50 p-6">
                <div className="w-12 h-12 border border-secondary-200 flex items-center justify-center text-secondary-500 shrink-0">
                  <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  ...
                  <address className="not-italic text-secondary-800 font-medium text-sm">
          ...
          <form className="flex flex-col gap-5 bg-primary-50/50 p-8 rounded-xl border border-primary-100">
            <h2 className="font-serif text-3xl text-secondary-900 mb-2">
              Envianos un mensaje
            </h2>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                rows={4}
                className="bg-white border border-secondary-200 focus:border-primary-500 outline-none text-secondary-800 px-4 py-3 text-sm transition-colors placeholder:text-secondary-400 resize-none"
                placeholder="Contanos sobre tu propiedad..."
              />
            </div>
            <button
              type="submit"
              className="bg-primary-600 text-white hover:bg-primary-700 transition-colors px-8 py-4 text-xs tracking-widest uppercase font-semibold self-start"
            >
              Enviar mensaje
            </button>
          </form>
